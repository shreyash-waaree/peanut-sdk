...
/* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/SensorInfraredApi.class */
@LinkAdapter(link = PeanutConstants.LinkType.COM, com = PeanutConstants.COM2, custom = true)
@SerialCommand(action = "70", body = "20")
public class SensorInfraredApi {
    private IDataCallback callBack;
    private RequestEnum requestEnum = RequestEnum.GET;

    @SerialResponse
    ApiCallback serialCallback = new ApiCallback<SerialData>() { // from class: com.keenon.sdk.api.SensorInfraredApi.1
        @Override // com.keenon.sdk.hedera.model.ApiCallback, com.keenon.sdk.hedera.model.ICallback
        public void onSuccess(SerialData result) {
            LogUtils.i(PeanutConstants.TAG_API, "[SensorInfraredApi][onSuccess raw: " + ByteUtils.toString(result.getData()) + "]");
            Bean bean = new Bean();
            bean.setBytes(result.getData());
            bean.setTopic(getClass());
            String jsonResult = GsonUtil.bean2String(bean);
            LogUtils.d(PeanutConstants.TAG_API, "[SensorInfraredApi][onSuccess json: " + jsonResult + "]");
            if (SensorInfraredApi.this.callBack == null) {
                return;
            }
            if (SensorInfraredApi.this.requestEnum == RequestEnum.GET) {
                SensorInfraredApi.this.callBack.success(jsonResult);
            } else if (SensorInfraredApi.this.requestEnum == RequestEnum.OBSERVER) {
        ...
        public void onFail(ApiError error) {
            ...
            if (SensorInfraredApi.this.requestEnum == RequestEnum.GET) {
                SensorInfraredApi.this.callBack.error(error);
            } else if (SensorInfraredApi.this.requestEnum == RequestEnum.OBSERVER) {
    ...
    /* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/SensorInfraredApi$Bean.class */
    public static class Bean extends ApiData implements Serializable {
        ...
        /* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/SensorInfraredApi$Bean$DataBean.class */
