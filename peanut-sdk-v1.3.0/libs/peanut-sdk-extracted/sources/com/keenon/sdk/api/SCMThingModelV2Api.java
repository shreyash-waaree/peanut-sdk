...
/* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/SCMThingModelV2Api.class */
@LinkAdapter(board = PeanutConstants.BoardType.EMOTION, link = PeanutConstants.LinkType.COM)
@SerialCommand(action = "7c", body = "20")
public class SCMThingModelV2Api {
    private IDataCallback callBack;
    private Byte[] payload;

    @SerialResponse
    ApiCallback serialCallback = new ApiCallback<SerialData>() { // from class: com.keenon.sdk.api.SCMThingModelV2Api.1
        @Override // com.keenon.sdk.hedera.model.ApiCallback, com.keenon.sdk.hedera.model.ICallback
        public void onSuccess(SerialData result) {
            if (SCMThingModelV2Api.this.callBack == null) {
                return;
            }
            LogUtils.i(PeanutConstants.TAG_API, "[SCMThingModelV2Api][onSuccess raw: " + ByteUtils.toString(result.getData()) + "]");
            if (result.getData() == null) {
                ApiError error = new ApiError(ApiCode.SCM_RESPONSE_EMPTY);
                SCMThingModelV2Api.this.callBack.error(error);
            } else {
