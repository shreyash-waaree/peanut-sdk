...
/* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/DoorTypeObserveApi.class */
@LinkAdapter(board = PeanutConstants.BoardType.DOOR, link = PeanutConstants.LinkType.COM)
@SerialCommand(action = "F4", body = "20")
public class DoorTypeObserveApi {
    private IDataCallback callBack;
    private RequestEnum requestEnum = RequestEnum.GET;

    @SerialResponse
    ApiCallback serialCallback = new ApiCallback<SerialData>() { // from class: com.keenon.sdk.api.DoorTypeObserveApi.1
        @Override // com.keenon.sdk.hedera.model.ApiCallback, com.keenon.sdk.hedera.model.ICallback
        public void onSuccess(SerialData result) {
            LogUtils.i(PeanutConstants.TAG_API, "[DoorTypeObserveApi][onSuccess raw: " + ByteUtils.toString(result.getData()) + "]");
            Bean bean = new Bean();
            bean.setTopic(getClass());
            bean.setBytes(result.getData());
            String jsonResult = GsonUtil.bean2String(bean);
            LogUtils.d(PeanutConstants.TAG_API, "[DoorTypeObserveApi][onSuccess json: " + jsonResult + "]");
            if (DoorTypeObserveApi.this.callBack == null) {
                return;
            }
            DoorTypeObserveApi.this.callBack.success(jsonResult);
        }
        ...
        public void onFail(ApiError error) {
            ...
            DoorTypeObserveApi.this.callBack.error(error);
        }
    };
    ...
    /* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/DoorTypeObserveApi$Bean.class */
    public static class Bean extends ApiData {
        ...
        /* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/DoorTypeObserveApi$Bean$DataBean.class */
