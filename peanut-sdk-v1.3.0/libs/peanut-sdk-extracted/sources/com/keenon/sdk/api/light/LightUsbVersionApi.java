package com.keenon.sdk.api.light;
...
/* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/light/LightUsbVersionApi.class */
...
public class LightUsbVersionApi {
    private IDataCallback callBack;

    @SerialResponse
    ApiCallback serialCallback = new ApiCallback<SerialData>() { // from class: com.keenon.sdk.api.light.LightUsbVersionApi.1
        ...
        */
        public void onSuccess(com.keenon.sdk.serial.base.SerialData r5) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.keenon.sdk.api.light.LightUsbVersionApi.AnonymousClass1.onSuccess(com.keenon.sdk.serial.base.SerialData):void");
        }

        @Override // com.keenon.sdk.hedera.model.ApiCallback, com.keenon.sdk.hedera.model.ICallback
        public void onFail(ApiError error) {
            if (LightUsbVersionApi.this.callBack == null) {
                return;
            }
            LightUsbVersionApi.this.callBack.error(error);
        }
    };
