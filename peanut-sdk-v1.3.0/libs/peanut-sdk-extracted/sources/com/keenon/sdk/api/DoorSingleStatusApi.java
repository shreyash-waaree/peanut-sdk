...
/* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/DoorSingleStatusApi.class */
@LinkAdapter(board = PeanutConstants.BoardType.DOOR, link = PeanutConstants.LinkType.COM)
@SerialCommand(action = "64", body = "21")
public class DoorSingleStatusApi {
    private IDataCallback callBack;

    @SerialResponse
    ApiCallback serialCallback = new ApiCallback<SerialData>() { // from class: com.keenon.sdk.api.DoorSingleStatusApi.1
        @Override // com.keenon.sdk.hedera.model.ApiCallback, com.keenon.sdk.hedera.model.ICallback
        public void onSuccess(SerialData result) {
            LogUtils.i(PeanutConstants.TAG_API, "[DoorSingleStatusApi][onSuccess raw: " + ByteUtils.toString(result.getData()) + "]");
            Bean bean = DoorSingleStatusApi.this.new Bean();
            bean.setBytes(result.getData());
            String jsonResult = GsonUtil.bean2String(bean);
            LogUtils.d(PeanutConstants.TAG_API, "[DoorSingleStatusApi][onSuccess json: " + jsonResult + "]");
            if (DoorSingleStatusApi.this.callBack == null) {
                return;
            }
            DoorSingleStatusApi.this.callBack.success(jsonResult);
        }
        ...
        public void onFail(ApiError error) {
            ...
            DoorSingleStatusApi.this.callBack.error(error);
        }
    };
    private int doorId;
    ...
    /* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/DoorSingleStatusApi$Bean.class */
    public class Bean implements Serializable {
        ...
        /* JADX INFO: loaded from: peanut-sdk-release.aar:classes.jar:com/keenon/sdk/api/DoorSingleStatusApi$Bean$DataBean.class */
